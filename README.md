...
○ Для файлов сохраните его размер в байтах, а для директорий размер файлов в ней с учётом всех вложенных файлов и директорий.
  ...
  - сделал 3 варианта решения.
  - Первые два DZ_08_ver_1.py и DZ_08_ver_2.py - в общем полностью одинаковые, основаны на функции os.listdir(dir_path). Там только немного логика записи отчета разная. Используется рекурсивный вызов функции самой себя. Затосчитаем размер файлов и вложенных все правильно - проверял
  - Третий вариант DZ_08_ver_1.py использует функцию os.walk(dir_path), но что то не учелю.. Подсчитывает только размер файлов, без учета вложенных папок.
