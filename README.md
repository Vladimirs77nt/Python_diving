...
...домашние задачи к семинару №8 - не решены... ❌
  ...
  Семинар - начинаю просматривать сегодня вечером (24.09.2023)

-----------------------------------------------------
...домашние задачи к семинару №7 - сейчас решаются !!! (24.09.2023)

Задание №1.
* Решить задачи, которые не успели решить на семинаре.

  <<< ВНИМАНИЕ !!! >>>
  - Запись семинара №7 (Файлы и файловая система) обрывается на 1:12:15, т.е. записано меньше чем полурока... На записи видно решение двух задач из семи.
  - Все задачи мною решены - находятся в папке Task_07
